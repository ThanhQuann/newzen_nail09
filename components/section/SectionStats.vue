    ...
    <div style="width: 100%;height: 100%;" class="">
      ...
      <div class="w-bg">
          <div class="cus-bg" >
              ...
              <div  class="d-flex cus-row row justify-content-between text-center mt">
              <div class="col-6 col-sm-3 col-lg-3 col-3">
                  <span class="fs-69"  ref="userCounter">0</span>
                  <div  class="fs-5 desc-mb"  v-html="block.list_stats.stats_user"></div>
              </div>
